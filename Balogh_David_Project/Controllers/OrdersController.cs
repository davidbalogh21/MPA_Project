...
namespace Balogh_David_Project
{
    public class OrdersController : Controller
    {
        ...
        {
            var laptopContext = _context.Orders.Include(o => o.Customer).Include(o => o.Laptop);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["LaptopID"] = new SelectList(_context.Laptops, "ID", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LaptopContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
